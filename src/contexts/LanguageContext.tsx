...
const translations = {
  ru: {
    ...
    'about.founderText': 'Меня зовут Алексей. Я ученик школы "Летово" в Москве. Я создал проект направленный на то, чтобы дать возможность школьникам и студентам со всей страны реализовывать свои идеи и воплощать их в жизнь.',
