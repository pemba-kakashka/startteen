...
const translations = {
  ru: {
    ...
    'about.founderText': 'Меня зовут Федоткин Алексей. Я ученик школы "Летово" в Москве. Я создал проект направленный на то, чтобы дать возможность школьникам и студентам со всей страны реализовывать свои идеи и воплощать их в жизнь.',
  ...
  en: {
    ...
    'about.founderText': 'My name is Fedotkin Alexey. I am a student at Letovo School in Moscow. I created a project aimed at giving students from all over the country the opportunity to realize their ideas and bring them to life.',
