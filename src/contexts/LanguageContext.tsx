...
const translations = {
  ru: {
    ...
    'about.historyText': 'Начало нашего проекта уходит корнями в моё детство. С самых ранних лет я мечтал стать бизнесменом или инвестором: постоянно придумывал идеи, особенно летом, когда мог часами продумывать, “как бы я сделал свой проект”. Но каждый раз я останавливался — то сомневался в идее, то не понимал, с чего начать, то просто не находил времени из-за учебной нагрузки. Летом 2025 года у меня наконец сложилась простая мысль: я не хочу, чтобы амбициозные ребята по всей стране — такие же, как я — теряли свои идеи из-за тех же барьеров. Так появилась StarTTeen: площадка, которая помогает сделать первый шаг, собрать поддержку и довести идею до реального результата. С этого момента проект перестал быть мечтой и стал делом.',
  ...
  en: {
    ...
    'about.historyText': 'The origins of our project go back to my childhood. From an early age, I dreamed of becoming a businessman or investor. I was constantly coming up with ideas—especially during the summer, when I could spend hours imagining how I would build my own project. But every time, I stopped: sometimes I wasn’t confident the idea was good enough, sometimes I didn’t know where to start, and sometimes I simply didn’t have the time because of academic workload. In the summer of 2025, one simple thought finally clicked: I didn’t want ambitious students across the country—people just like me—to lose their ideas for the same reasons. That’s how StarTTeen was born: a platform that helps young people take the first step, find support, and turn an idea into a real result. From that moment, it stopped being just a dream and became a real project.',
